...
directory = '../data/table_builder/'
table_builder_df = import_table_builder_outputs(directory)
compound_dataset_df = pandas.concat([dataset_df, table_builder_df], axis=1).rename(index={'region_id': 'GeographyId'})
